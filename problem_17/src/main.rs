...
fn get_word(n: i64) -> String {
    ...
    dict.insert(40, "fourty");
    dict.insert(50, "fifty");
    dict.insert(60, "sixty");
    dict.insert(70, "seventy");
    dict.insert(80, "eighty");
    dict.insert(90, "ninty");
    dict.insert(100, "onehundred");
    dict.insert(200, "twohundred");
    dict.insert(300, "threehundred");
    dict.insert(400, "fourhundred");
    dict.insert(500, "fivehundred");
    dict.insert(600, "sixhundred");
    dict.insert(700, "sevenhundred");
    dict.insert(800, "eighthundred");
    dict.insert(900, "ninehundred");
